...
namespace PoseidonTests
{
    ...
    public class SigningTests
    {
        ...
        public void PoseidonEddsaTest3()
        {
            ...
            BigInteger poseidonHash = poseidon.CalculatePoseidonHash(inputs);
            Assert.AreEqual(BigInteger.Parse("4039926191380788949286172671420227647869138762868816863744279168259334375146"), poseidonHash);
            Eddsa eddsa = new Eddsa(poseidonHash, PrivateKey3);
            string signedMessage = eddsa.Sign();
            Assert.AreEqual("0x08b2d831b6405695ee6c3ed9e87c4a3ca3616edd8a53190defc7421f4db352f72b9d62fb33252df1b6b3f308410c13c42d83fc4a68272718d40db85fd34a0b6203e2dfda1bc31828d0d0329f4d57a6f098e1fecd8c7e091b6a3138dcd43d2c67", signedMessage);
        }
